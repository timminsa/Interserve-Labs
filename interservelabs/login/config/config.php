...
define("COOKIE_SECRET_KEY", "1gp@Tz543MPS{+dssFe-92s");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://interservelabs.com/login/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@interservelabs.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Doei Bugs");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for Doei Bugs");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://interservelabs.com/login/register.php");
define("EMAIL_VERIFICATION_FROM", "no-reply@interservelabs.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Interserve Labs");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for Interserve Labs");
